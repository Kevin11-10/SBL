...
const TEAMS = [
    ...
    { id: 5, name: "Somto FC", manager: 'Somto' },
    { id: 6, name: "Emmanuel United", manager: 'Emmanuel' },
    { id: 7, name: "Layomi FC", manager: 'Layomi' },
